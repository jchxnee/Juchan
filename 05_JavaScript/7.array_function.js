...
//2) a를 b보다 먼저 정렬하고 싶다면(앞에두려면) 0보다 작은수를 반환
//3) 원래순서유지 -> 0반환
...
let tmpMember = members2.map(m => m); //값복사 앞에값에 members2의 값을 받아와 => 뒤에값을 리턴
...
//모든요소가 조건에 부합하지 않는다면(undefined를 반환함)
