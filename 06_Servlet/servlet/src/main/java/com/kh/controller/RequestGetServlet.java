...
public class RequestGetServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      // Get방식으로 요청시 해당 doGet메서드가 저절로 호출된다.(톰팻이 서블릿객체를 생성해서 메서드 호출까지 함)
      ...
      String city = request.getParameter("city"); // "서울"|"경기"..
      double height = Double.parseDouble(request.getParameter("height")); // "173.2" -> 173.2
      ...
      // 1) 응답으로 출력할 내용을 html이고 문자셋은 utf-8이다 -> 선언
