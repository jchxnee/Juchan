...
function App() {
  ...
  const uploadFile = async (path) => {
    try{
      ...
      const response = await axios.get('https://8xlxmapf76.execute-api.ap-northeast-2.amazonaws.com/default/getPresignedUrl',{
        params: {
    ...
    <div className='app-container'>
...

      {
        ...
        <div className='status'>
          <p>{status}</p>
         <img src={`https://d288d1yk89a3b7.cloudfront.net/user-profile/${downloadFileInfo?.filename}`}/>
        </div>
      }
    </div>
  )
