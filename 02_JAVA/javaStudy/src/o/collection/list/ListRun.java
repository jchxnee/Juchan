...
public class ListRun {
	...
	public static void main(String[] args) {
		//ArrayList
		List list = new ArrayList(); //크기를 지정해도되고 안해도됨
		...
		//지정된 크기보다 더 많이 넣어도 에러가 발생하지 않는다. -> 장정1. 크기제약x
		//다양한 타입의 데이터를 담을 수 있음 -> 장점2. 여러타입을 보관가능
		...
		//4. set(int index, E e) : 해당인덱스의 값을 전달받은 e객체로 덮어씌움
		...
		List sub = list.subList(1, 3); //1번인덱스부터 3번인덱스 전까지 첫번째변수부터 두번째변수-1까지
		...
		//9. isEmpty() : boolean -> 컬렉션이 비어있는지 확인하는 메소드
