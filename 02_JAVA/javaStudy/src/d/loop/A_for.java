...
public class A_for {
	...
	public static void main(String[] args) {
		...
		System.out.println("아메리카노 몇잔을 구매하시겠습니까?(가격1500원) : ");
		count = sc.nextInt();
	   ...
	   /*
		  ...
		  int num = (int)Math.random() * 10 + 1; (0.0 ~ 9.9999999999999) + 1 ->  1 ~ 10
