...
/*
 	...
 	static변수와 static메소드는 정적메모리를 사용하여 프로그램 실행시점에 따로 객체생성없이
 	메모리가 생성되며, 이를 모든 객체가 공유해서 사용한다.
 	
 	클래스(static)변수 : 한 클래스에서 공통적인 값을 유지해야할 때 사용
 	클래스(static)메소드 : 인스턴스 변수를 사용할 수 없으므로 인스턴스와 관계없는 메소드를 클래스메소드로 사용한다.
 */
public class Run {
	...
	public static void main(String[] args) {
		...
		*/
		/*
		Human.count++;
		Human h1 = new Human("이주찬", 26);
		Human h2 = new Human("황인태", 36);
		h1.inform();
		h2.inform();
		*/
