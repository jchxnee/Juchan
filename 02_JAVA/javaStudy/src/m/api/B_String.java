...
public class B_String {
	public void method01() {
		...
		//String클래스에 toString메소드는 이미 오버라이딩 되어있음
		 ...
		 //String클래스에서 equals메소드는 이미 오버라이딩 되어있음(주소값비교가 아닌 값비교)
		 
		 System.out.println(str1.hashCode());
		 System.out.println(str2.hashCode());
		 //String클래스에서 hashcode메소드도 이미 오버라이딩 되어있음(주소값이 아닌 문자열을 가지고 만듦)
		 ...
		 String str4 = "hello";
		 //리터럴 제시시 상수풀영역에 들어감
		 //String pool특징 : 동일한 문자열을 중복해서 가지지 않는다 -> 주소값이 같다
	...
	public void method02() {
		...
		//문자열에서 대상문자를 찾아서 변경할문자로 변환된 문자열 반환
